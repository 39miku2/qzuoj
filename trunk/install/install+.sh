...
if [ -n "${centos7}" ];then
    ...
    sudo curl https://raw.githubusercontent.com/ifwlzs/qzuoj/master/trunk/install/install-centos7.sh | sudo bash ;
elif [ -n "${ubuntu14}" ];then
    echo "Ubuntu14.* detected" ;
    sudo apt-get -y install curl ;
    sudo curl https://raw.githubusercontent.com/ifwlzs/qzuoj/master/trunk/install/install-ubuntu14.04.sh | sudo bash ;
elif [ -n "${ubuntu16}" ];then
    echo "Ubuntu16.* detected" ;
    sudo apt-get -y install curl ;
    sudo curl https://raw.githubusercontent.com/ifwlzs/qzuoj/master/trunk/install/install-ubuntu16+.sh | sudo bash ;
elif [ -n "${ubuntu18}" ];then
    echo "Ubuntu18.* detected" ;
    sudo apt-get -y install curl ;
    sudo curl https://raw.githubusercontent.com/ifwlzs/qzuoj/master/trunk/install/install-ubuntu18.04.sh | sudo bash ;
else
